class OrdenPlanificada(object):
    def __init__(self, id, refOrden, fechaFabricacion, horaInicioPlanificada, horaTerminoPlanificada, botellasPlanificadas, cajasPlanificadas, estado, secuencia, version):
        self.id = id
